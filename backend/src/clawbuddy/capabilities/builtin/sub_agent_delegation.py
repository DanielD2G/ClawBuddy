...
Replaces: apps/api/src/capabilities/builtin/sub-agent-delegation.ts
"""
...
SUB_AGENT_DELEGATION: dict[str, Any] = {
    ...
    "tools": [
        {
            "name": "delegate_task",
            "description": (
                "Delegate a task to a focused sub-agent. Available roles:\n"
                ...
                "**Batch multiple delegate_task calls in a single response whenever possible "
                "— they run concurrently and finish much faster than sequential calls.**"
            ),
            "parameters": {
                "type": "object",
                "properties": {
