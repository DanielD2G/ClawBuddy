...
export const googleWorkspace: CapabilityDefinition = {
  slug: 'google-workspace',
  name: 'Google Workspace',
  description:
    'Google Workspace: Gmail (send, search, read emails), Calendar (agenda, events, schedule, meetings, appointments), Drive (upload, download, search files), Tasks, Docs, Sheets, and more.',
  icon: 'Mail',
  ...
  tools: [
    {
      ...
      description:
        ...
        '- Raw API: calendar events list --params \'{"calendarId":"primary","timeMin":"2026-03-01T00:00:00Z","timeMax":"2026-04-01T00:00:00Z","singleEvents":true}\'\n' +
