...
You need at least **one** provider API key to use AgentBuddy. Add it to your `.env` file.
...
3. Name it (e.g., `AgentBuddy`) and click **Create**
...
5. Under **Authorized redirect URIs**, add:
   ...
   ```
   If you're running AgentBuddy on a different URL, replace `http://localhost:4321` with your `APP_URL`.
6. Click **Create**
...
If your AgentBuddy is not on `localhost:4321`, also set:

```env
APP_URL="https://your-domain.com"
```

### Step 6: Connect in AgentBuddy

1. Open AgentBuddy and go to **Settings > Capabilities**
...
| `APP_URL` | If not localhost | Your AgentBuddy URL (default: `http://localhost:4321`) |
